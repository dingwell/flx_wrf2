...
C     temporal interpolation of precipitation
      yint1 = p1*yy1(ix ,jy ,level,memind(2),ngrid)
     +      + p2*yy1(ixp,jy ,level,memind(2),ngrid)
     +      + p3*yy1(ix ,jyp,level,memind(2),ngrid)
     +      + p4*yy1(ixp,jyp,level,memind(2),ngrid)
      yint2 = p1*yy2(ix ,jy ,level,memind(2),ngrid)
     +      + p2*yy2(ixp,jy ,level,memind(2),ngrid)
     +      + p3*yy2(ix ,jyp,level,memind(2),ngrid)
     +      + p4*yy2(ixp,jyp,level,memind(2),ngrid)
C /AD
...
C     temporal interpolation of precipitation
c       y1(m)=p1*yy1(ix ,jy ,level,indexh,ngrid)
c    +      + p2*yy1(ixp,jy ,level,indexh,ngrid)
c    +      + p3*yy1(ix ,jyp,level,indexh,ngrid)
c    +      + p4*yy1(ixp,jyp,level,indexh,ngrid)
c       y2(m)=p1*yy2(ix ,jy ,level,indexh,ngrid)
c    +      + p2*yy2(ixp,jy ,level,indexh,ngrid)
c    +      + p3*yy2(ix ,jyp,level,indexh,ngrid)
c    +      + p4*yy2(ixp,jyp,level,indexh,ngrid)
c /AD
